...
import { Phone, Calendar } from '@/components/social-icons';
...
export default function MobileFAB() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-card-bg/90 backdrop-blur-md border-t border-border" />
      ...
      <div className="relative flex items-center justify-between px-4 py-3 gap-3">
        ...
        <a
          ...
          className="flex flex-col items-center gap-1 flex-1 py-2 text-primary hover:text-secondary transition-colors"
          aria-label="Call us"
        >
        ...
        <a
          ...
          className="flex flex-col items-center gap-1 flex-1 py-2 text-[#25D366] hover:text-[#128C7E] transition-colors"
