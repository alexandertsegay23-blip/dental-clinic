          ...
          <div className="bg-card-bg rounded-xl border border-border p-6 max-w-md w-full">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {selectedAppointment.patient_email && (
                    <div className="text-sm text-text-muted">{selectedAppointment.patient_email}</div>
                  )}
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm text-text">{selectedAppointment.date}</div>
                  <div className="text-sm text-text-muted">{selectedAppointment.time_slot}</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-sm text-text-muted">Service:</span>
                <span className="text-sm text-text font-medium">{selectedAppointment.service_name}</span>
              </div>
              {selectedAppointment.doctor_name && (
                <div className="flex items-center gap-3">
                  <span className="text-sm text-text-muted">Doctor:</span>
                  <span className="text-sm text-text font-medium">{selectedAppointment.doctor_name}</span>
                </div>
              )}
              <div className="flex items-center gap-3">
              ...
              <div className="pt-3 border-t border-border">
                ...
                <p className="text-sm text-text">{selectedAppointment.notes || 'No additional notes'}</p>
              </div>
              <div className="pt-2 border-t border-border">
                <p className="text-xs text-text-muted">Created: {selectedAppointment.created_at}</p>
              </div>
            </div>
